...
RAGE_ELIXIR = 5
NUKE_ELIXIR = 6
WALL_BREAKER_ELIXIR = 3
POISON_ELIXIR = 5

SPAWN_RELOAD = 20
FREEZE_RELOAD = 4
BURN_RELOAD = 1
WALL_BREAKER_RELOAD = 1
ZOMBIE_RELOAD = 2
BRIDGE_RELOAD = 2
D_BRIDGE_RELOAD = 8
...
WALL_BREAKER_BREAKDOWN = AbilityBreakdown("V", "Wall-Breaker", WALL_BREAKER_COST, WALL_BREAKER_RELOAD, WALL_BREAKER_CREDITS, WALL_BREAKER_ELIXIR)
RAGE_BREAKDOWN = AbilityBreakdown("R", "Rage", RAGE_COST, RAGE_RELOAD, RAGE_CREDITS, RAGE_ELIXIR)
OVER_GROW_BREAKDOWN = AbilityBreakdown("O", "Over-Grow", OVER_GROW_COST, OVER_GROW_RELOAD, OVER_GROW_CREDITS, OVER_GROW_ELIXIR)
