...
from Frontend.constants import EVENT_CODES
...
COUNTDOWN_LENGTH = 59.0
MAIN_GAME_LENGTH = 120.0
...
EVENT_CODES = {STANDARD_LEFT_CLICK, STANDARD_RIGHT_CLICK, CANNON_SHOT_CODE, PUMP_DRAIN_CODE}
...
EVENTS = {CANNON_SHOT_CODE, PUMP_DRAIN_CODE, STANDARD_LEFT_CLICK, STANDARD_RIGHT_CLICK}