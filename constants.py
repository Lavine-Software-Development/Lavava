...
SERVER_UG = '100.69.14.241'
SERVER_CO = '192.168.9.150'
SERVER_D = '192.168.0.200'
SERVER_L = '192.168.2.209'
...
LETTER_TO_CODE = {'S': SPAWN_CODE, 'B': BURN_CODE, 'A': BRIDGE_CODE, 'D': D_BRIDGE_CODE, 'P': POISON_CODE, 'F': FREEZE_CODE, 'N': NUKE_CODE, 'C': CAPITAL_CODE}

RELOAD_ABILITIES = {BRIDGE_CODE, D_BRIDGE_CODE, NUKE_CODE, POISON_CODE, FREEZE_CODE}
MONEY_ABILITIES = {BRIDGE_CODE, D_BRIDGE_CODE, NUKE_CODE, POISON_CODE, FREEZE_CODE, CAPITAL_CODE}
PORTS_ABILITIES = {BRIDGE_CODE, D_BRIDGE_CODE, NUKE_CODE, POISON_CODE, FREEZE_CODE, CAPITAL_CODE, BURN_CODE}
