...
import pygame as py
from constants import BURN_CODE, RAGE_CODE, PORT_COUNT, SPAWN_CODE, FREEZE_CODE, ZOMBIE_CODE, NUKE_CODE, BRIDGE_CODE, POISON_CODE
...
class TestMain(Main):
    ...
    def choose_abilities(self, abi, credits):
        av = make_ability_validators(self.logic, self.my_player)
        counts = {BRIDGE_CODE: 2, NUKE_CODE: 2, POISON_CODE: 2}
