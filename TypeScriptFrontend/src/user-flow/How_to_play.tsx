            ...
            <div className="space">
                ...
                <ul>
                    ...
                    <li>
                        ...
                        rate. Meant for a rush-esque play. Offensive
                    </li>
                    <li>
                ...
                <ul>
                    ...
                    <li>
                        ...
                        it returns to a normal node. Defensive.
                    </li>
                    <li>
                        ...
                        now has access to the cannon. Offensive/Defensive.
                    </li>
                    <li>? Need one more 3 credit ability.</li>
                </ul>
            </div>
            <div className="space">
                <h1>FAQ</h1>
